...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/retweets_1/sa_sa_cm \
  --time-scale 1e-3 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/retweets_2/sa_sa_cm \
  --time-scale 1e-3 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/retweets_3/sa_sa_cm \
  --time-scale 1e-3 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/retweets_4/sa_sa_cm \
  --time-scale 1e-3 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/retweets_5/sa_sa_cm \
  --time-scale 1e-3 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
