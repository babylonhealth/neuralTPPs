...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/ear_infection_1/gru_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/ear_infection_2/gru_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/ear_infection_3/gru_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/ear_infection_4/gru_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/ear_infection_5/gru_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
