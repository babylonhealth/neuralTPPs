...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/synthea_1/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/synthea_2/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/synthea_3/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/synthea_4/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/synthea_5/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
