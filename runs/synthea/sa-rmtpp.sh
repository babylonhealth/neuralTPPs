...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/synthea_1/sa_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/synthea_2/sa_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/synthea_3/sa_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/synthea_4/sa_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir /home/air/project/neural-tpps/plots/synthea_5/sa_rmtpp \
  --time-scale 1e-5 \
  --save-model-freq 25 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
