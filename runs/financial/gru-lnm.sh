...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_1/gru_lnm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_2/gru_lnm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_3/gru_lnm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_4/gru_lnm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_5/gru_lnm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
