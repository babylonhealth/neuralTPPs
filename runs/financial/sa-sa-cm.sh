...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_1/sa_sa_cm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_2/sa_sa_cm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_3/sa_sa_cm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_4/sa_sa_cm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/financial_5/sa_sa_cm \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
