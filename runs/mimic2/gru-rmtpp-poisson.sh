...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/mimic2_1/gru_rmtpp_poisson \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/mimic2_2/gru_rmtpp_poisson \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/mimic2_3/gru_rmtpp_poisson \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/mimic2_4/gru_rmtpp_poisson \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/mimic2_5/gru_rmtpp_poisson \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
