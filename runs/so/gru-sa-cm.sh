...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/so_1/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/so_2/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/so_3/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/so_4/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/so_5/gru_sa_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
