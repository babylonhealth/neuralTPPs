...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/hawkes_1_1/gru_sa_mc \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --batch-size 512 \
  --data-dir ~/neural-tpps/data \
  --plots-dir ~/neural-tpps/plots/hawkes_1_2/gru_sa_mc \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --batch-size 512 \
  --data-dir ~/neural-tpps/data \
  --plots-dir ~/neural-tpps/plots/hawkes_1_3/gru_sa_mc \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --batch-size 512 \
  --data-dir ~/neural-tpps/data \
  --plots-dir ~/neural-tpps/plots/hawkes_1_4/gru_sa_mc \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
...
python scripts/train.py \
  ...
  --batch-size 512 \
  --data-dir ~/neural-tpps/data \
  --plots-dir ~/neural-tpps/plots/hawkes_1_5/gru_sa_mc \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
  --lr-scheduler-warmup 10 \
